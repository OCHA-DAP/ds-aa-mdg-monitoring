...
<p class="note">Automated alert from the OCHA Centre for Humanitarian Data.
Generated by <a href="https://github.com/OCHA-DAP/ds-aa-mdg-monitoring">ds-aa-mdg-monitoring</a>.</p>
